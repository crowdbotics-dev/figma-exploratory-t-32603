...
## Project Structure
    ...
    ├── figma_exploratory_t_32603  # Django project configurations
...
1. Clone this repo and `cd figma_exploratory_t_32603`
...
2. Clone this repo and `cd figma_exploratory_t_32603`
